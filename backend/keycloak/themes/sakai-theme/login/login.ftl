            ...
            <div class="card-wrapper">
                <div class="card">
                     <div class="text-center mb-8">
                        ...
                        <div class="title">Welcome to Inventory Orchestrator!</div>
                        <span class="subtitle">Sign in to continue</span>
                    </div>

                    <#if message?has_content && (message.type != 'warning' || !isAppInitiatedAction??)>
                        <div class="alert-${message.type} ${properties.kcAlertClass!} pf-m-${(message.type = 'error')?then('danger', message.type)}">
                    ...
                    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                        <div class="form-group">
                            ...
                            <input tabindex="1" id="username" class="input" name="username" value="${(login.username!'')}"  type="text" autofocus autocomplete="off" />
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button tabindex="4" class="button" name="login" id="kc-login" type="submit">${msg("doLogIn")}</button>
                        </div>
                    </form>
                </div>
            </div>
