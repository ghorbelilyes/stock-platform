...
public interface TransferRepository extends JpaRepository<Transfer, Long> {
        ...
        List<Transfer> findByStoreInvolved(@Param("storeSent") Long idStoreSent,
                        @Param("storeReceive") Long idStoreReceive);
        ...
        /**
         * Sum quantities of approved or in-transit transfers by destination store and
         * product.
         * This represents incoming quantity for a location (approved or shipped but not
         * yet received).
        ...
        /**
         * Sum quantities of in-transit transfers by source store and product. Returns
         * [storeId, productId, sum].
         */
        ...
        /**
         * Sum quantities of approved transfers by source store and product. Returns
         * [storeId, productId, sum].
         */
        ...
        /**
         * Find transfers not yet received (status not in 'received', 'closed') where
         * the given store
         * is either source or destination and the product matches. Used for stock row
         * expansion.
         */
        @Query(value = "SELECT new com.inventory.orchestrator.dto.TransferView(" +
                        "t.id, t.date, t.idStoreSent, t.idStoreReceive, t.idProduct, t.reason, t.quantity, t.status, " +
                        ...
                        "AND (:statuses IS NOT NULL OR t.status NOT IN ('received', 'closed')) " +
                        "ORDER BY t.date DESC")
        List<TransferView> findTransfersByStoreAndProduct(@Param("storeId") Long storeId,
                        @Param("productId") Long productId, @Param("statuses") List<String> statuses);
}
