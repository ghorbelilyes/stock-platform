...
@Component({
    selector: 'app-login',
    standalone: true,
    imports: [ButtonModule, RippleModule, AppFloatingConfigurator],
    template: `
                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome to Inventory Orchestrator!</div>
                        ...
                        <div>
                            ...
                            @if (errorMessage) {
                                <div class="mt-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded text-red-700 dark:text-red-300">
                                    {{ errorMessage }}
                                </div>
                            }
                        </div>
...
export class Login implements OnInit {
    ...
    async ngOnInit(): Promise<void> {
        ...
        await this.keycloakService.waitForInitialization();
